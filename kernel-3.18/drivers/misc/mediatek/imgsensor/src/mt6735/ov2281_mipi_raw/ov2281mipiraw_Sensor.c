...
#include "ov2281mipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		...
		.framelength = 2044,				//record different mode's framelength
...
static imgsensor_struct imgsensor = {
	...
	.current_fps = 130,  						//full size current fps : 24fps for PIP, 30fps for Normal or ZSD
...
{   { 1080, 1920,	  0,  0, 1080, 1920, 1080, 1920, 0, 0, 1080, 1920,	  0,	0, 1080, 1920}, // Preview
    { 1080, 1920,	  0,  0, 1080, 1920, 1080, 1920, 0, 0, 1080, 1920,	  0,	0, 1080, 1920}, // capture
    { 1080, 1920,	  0,  0, 1080, 1920, 1080, 1920, 0, 0, 1080, 1920,	  0,	0, 1080, 1920}, // video
    { 1080, 1920,	  0,  0, 1080, 1920, 1080, 1920, 0, 0, 1080, 1920,	  0,	0, 1080, 1920}, //hight speed video
    { 1080, 1920,	  0,  0, 1080, 1920, 1080, 1920, 0, 0, 1080, 1920,	  0,	0, 1080, 1920}};// slim video
...
*
* DESCRIPTION
*	This function is to get the value from sensor addr.
*
* PARAMETERS
*	addr : Sensor register addr.
*
* RETURNS
*	The value read from addr of sensor
*
*************************************************************************/
...
*
* DESCRIPTION
*	This function is to write the value to sensor addr.
*
* PARAMETERS
*	addr : Sensor register addr.
*	para : The value we wish to write.
*
* RETURNS
*	NULL
*
...
*
* DESCRIPTION
*	This function is to set dummy setting.
*
* PARAMETERS
*	NULL
*
...
*
* DESCRIPTION
*	This function is to set max framerate
*
* PARAMETERS
*	framerate 			: Max framerate.
*	min_framelength_en 	: Min framelength enable
*
* RETURNS
*	NULL
*
...
*
* DESCRIPTION
*	This function is to write shutter setting to sensor
*
* PARAMETERS
...
*
* DESCRIPTION
*	This function to cover gain to reg gain
*
* PARAMETERS
*	gain : gain value we set from user
*
* RETURNS
*	the reg gain that sensor can be accept
*
* GLOBALS AFFECTED
*
*************************************************************************/
...
*
* DESCRIPTION
*	This function is to mirror flip display.
*
* PARAMETERS
*	image_mirror:mirror direction
*
* RETURNS
*	NULL
*
...
*
* DESCRIPTION
*	This function is set initial parameter to sensor.
*
* PARAMETERS
*	NULL
*
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x3b00, 0x02);
    write_cmos_sensor(0x3b03, 0xff);
	write_cmos_sensor(0x3b02, 0x0f);
    write_cmos_sensor(0x3b00, 0x82);
...
*
* DESCRIPTION
*	This function is set preview parameter to sensor.
*
* PARAMETERS
*	NULL
*
...
static void preview_setting(void)
{
    ...
    //Add register setting as Istvan adviced
    write_cmos_sensor(0x3837, 0x00);
    write_cmos_sensor(0x3b00, 0x02);
    write_cmos_sensor(0x3b03, 0xff);
    write_cmos_sensor(0x3b02, 0x0f);
...
*
* DESCRIPTION
*	This function is set capture parameter to sensor.
*
* PARAMETERS
*	NULL
*
...
*
* DESCRIPTION
*	This function is set video parameter to sensor.
*
* PARAMETERS
*	NULL
*
...
*
* DESCRIPTION
*	This function start the sensor video.
*
* PARAMETERS
*	image_window : address pointer of pixel numbers in one period of HSYNC
*   sensor_config_data : address pointer of line numbers in one period of VSYNC
...
*
* DESCRIPTION
*	This function is get camera setting, like width and height.
*
* PARAMETERS
*	sensor_resolution : set
*
* RETURNS
*	None
*
...
*
* PARAMETERS
*	scenario_id 		: which function do you want to get, preview, capture or video?
*	sensor_info 		: The sensor information the app want to get.
*	sensor_config_data 	: The sensor configuration the app want to get.
*
* RETURNS
*	None
*
...
*
* DESCRIPTION
*	This function is control command .
*
* PARAMETERS
*	scenario_id 		: which function do you want to get, preview, capture or video?
*	image_window 		: address pointer of pixel numbers in one period of HSYNC
...
*
* DESCRIPTION
*	This function is to set video frame rate.
*
* PARAMETERS
*	framerate 	: the frame rate value we set to camera.
*
* RETURNS
*	None
*
...
*
* DESCRIPTION
*	This function is to set the camera's auto flicker function.
*
* PARAMETERS
*	enable 		: auto flicker function enable or disable.
*	framerate 	: the frame rate value we set to camera.
*
* RETURNS
*	None
...
*
* DESCRIPTION
*	This function is to set video max frame rate according to sensor mode.
*
* PARAMETERS
*	scenario_id : which function do you want to get, preview, capture or video?
*	framerate 	: the frame rate value we set to camera.
...
*
* DESCRIPTION
*	This function is to get video frame rate according to sensor mode.
*
* PARAMETERS
*	scenario_id : which function do you want to get, preview, capture or video?
*	framerate 	: the frame rate value we get from camera.
*
* RETURNS
*	None
*
...
*
* DESCRIPTION
*	This function is to set test mode.
*
* PARAMETERS
*	enable : set test mode to sensor enable or disable.
*
* RETURNS
*	None
*
...
*
* DESCRIPTION
*	This function is the control aggregate set parameter to sensor or get from sensor
*
* PARAMETERS
*	feature_id 			: which control we wish to run.
*	feature_para 		: the parameter data we wish to set to or get from sensor.
*	feature_para_len 	: the length of the parameter data.
*
* RETURNS
*	None
*
...
*
* DESCRIPTION
*	This function is initial the control function pointer.
*
* PARAMETERS
*	pfFunc 	: the entrance of actual operation function.
*
* RETURNS
*	None
*
*************************************************************************************/
UINT32 OV2281MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
